  ...
  <div class="card-body">
    <div class="col-md-12">
                  ...
                  <input type="hidden" id="ecn_id" name='ecn_id'  value="<?=$ecn_id?>"/>
                        ...
                        <input type="text"  name="created_date" value="<?=$created_date?>"  class="form-control"  placeholder="Create Date" readonly>
                        </div>
                        <script>
                 ...
                 <br>
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" name="stock_sup" value="<?=$stock_sup?>" class="form-control"  placeholder="Stock/Cost Supplier">
                        </div>
                        <div class="form-group col-md-6">
                        <label>Assy Change</label>
                        <input type="text" name="cost_sup" value="<?=$cost_sup?>" class="form-control"  placeholder="Assy Change">
                        </div>
                    </div>
